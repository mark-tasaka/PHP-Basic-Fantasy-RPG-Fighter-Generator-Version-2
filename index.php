...
<html>
<head>
<title>Launch Page: Fighter Character Generator Basic Fantasy RPG</title>
...
<body>
	...
	<section>
		...
		<h1><img src="launchPage/images/title.png" alt="Fighter Character Generator Basic Fantasy RPG" class="image" /></h1>
		...
		<form action="" id ="FighterFormV3"  target="_blank" method="post">
...
<option value="16">16th Level, Fighter</option>
<option value="17">17th Level, Fighter</option>
<option value="18">18th Level, Fighter</option>
<option value="19">19th Level, Fighter</option>
<option value="20">20th Level, Fighter</option>
</select>
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#FighterFormV3").attr('action', "character2/basicFighter.php");
